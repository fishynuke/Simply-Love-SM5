...
t[#t+1] = LoadFont("_jfonts/_jfonts 16px")..{
	...
	GainFocusCommand=function(self) self:stoptweening():zoom(1):accelerate(0.1):diffuse(PlayerColor(PLAYER_2)):glow(1,1,1,0.5):decelerate(0.05):glow(1,1,1,0) end,
	LoseFocusCommand=function(self) self:stoptweening():zoom(0.8):accelerate(0.1):diffuse(ThemePrefs.Get("RainbowMode") and {1,1,1,1} or color("#888888")):glow(1,1,1,0) end
}
